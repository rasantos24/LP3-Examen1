...
int main( int argc, char* args[] )
{
    ...
    if((window = SDL_CreateWindow("Juego de Practica", 100, 100, 1080/*WIDTH*/, 720/*HEIGHT*/, SDL_WINDOW_RESIZABLE | SDL_RENDERER_PRESENTVSYNC)) == NULL)
    {
        return 20;
    }
    //SDL Renderer
...
//        }
        ...
        if((*p)->muerto)
        {
            //list<Personaje*>::iterator t = p;

            personajes.erase(p);
            break;

            //if(p!=personajes.begin())
            //p--;
        }
